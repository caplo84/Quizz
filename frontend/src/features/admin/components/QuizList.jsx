                ...
                <td className="px-4 py-3">
                  <div className="flex justify-end gap-2">
                    ...
                    <button
                      ...
                      title={reviewState ? 'Xem báo cáo AI review' : 'Chạy AI Review trước để xem report'}
                    >
                    ...
                    <button
                      ...
                      title={!canPublish && !quiz.isActive ? 'Chạy AI Review trước. Chỉ publish khi mức đánh giá là Tốt.' : ''}
                    >
